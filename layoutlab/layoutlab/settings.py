"""
Django settings for layoutlab project.
...
SECRET_KEY = 'django-insecure-kyc$%e-*gcfl-78-f#4#iofwt01-d^ufvjo1-p@w84(rq55h7h'
...
EMAIL_DEFAULT_SENDER_NAME = os.getenv('MAIL_DEFAULT_SENDER_NAME', 'LayoutLabX')  
...
WSGI_APPLICATION = 'layoutlab.wsgi.application'
